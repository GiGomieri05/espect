...
import 'formulario_lancamentos_model.dart';
export 'formulario_lancamentos_model.dart';

class FormularioLancamentosWidget extends StatefulWidget {
  const FormularioLancamentosWidget({
    super.key,
  ...
  @override
  State<FormularioLancamentosWidget> createState() =>
      _FormularioLancamentosWidgetState();
}

class _FormularioLancamentosWidgetState
    extends State<FormularioLancamentosWidget> with TickerProviderStateMixin {
  late FormularioLancamentosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FormularioLancamentosModel());
    ...
    _model.temperaturaTextController ??= TextEditingController();
    _model.temperaturaFocusNode ??= FocusNode();

    _model.aguaTextController ??= TextEditingController();
    _model.aguaFocusNode ??= FocusNode();

    _model.vinagreTextController ??= TextEditingController();
    _model.vinagreFocusNode ??= FocusNode();

    _model.bicarbonatoTextController ??= TextEditingController();
    _model.bicarbonatoFocusNode ??= FocusNode();

    _model.concentracaovinagreTextController ??= TextEditingController();
    _model.concentracaovinagreFocusNode ??= FocusNode();

    _model.pressaoTextController ??= TextEditingController();
    _model.pressaoFocusNode ??= FocusNode();

    _model.tempopressurizacaoTextController ??= TextEditingController();
    _model.tempopressurizacaoFocusNode ??= FocusNode();

    _model.tempodevooTextController ??= TextEditingController();
    _model.tempodevooFocusNode ??= FocusNode();

    _model.alcanceTextController ??= TextEditingController();
    _model.alcanceFocusNode ??= FocusNode();
    _model.alcanceFocusNode!.addListener(() => setState(() {}));
    WidgetsBinding.instance.addPostFrameCallback((_) => setState(() {
          _model.concentracaovinagreTextController?.text = '4';
        }));
  }
                                ...
                                children: [
                                  ...
                                  Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        0.0, 0.0, 0.0, 16.0),
                                    child: Text(
                                      'Selecione qual foguete que você lançou para que possamos começar!',
                                      style: FlutterFlowTheme.of(context)
                                          .labelLarge
                                          .override(
                                            fontFamily:
                                  ...
                                  if (FFAppState().selectedFoguete == null ||
                                      FFAppState().selectedFoguete == '')
                                    FutureBuilder<List<FoguetesRecord>>(
                                      future: queryFoguetesRecordOnce(
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        return ListView.builder(
                                          ...
                                          itemCount:
                                              listViewFoguetesRecordList.length,
                                          itemBuilder:
                                  ...
                                  if (_model.fogueteSelecionadoPagina != null)
                                    Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          0.0, 16.0, 0.0, 0.0),
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Container(
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.temperaturaTextController,
                                        focusNode: _model.temperaturaFocusNode,
                                        autofocus: true,
                                        obscureText: false,
                                ...
                                children: [
                                              ...
                                              Padding(
                                                padding: EdgeInsetsDirectional
                                                    .fromSTEB(
                                                        0.0, 0.0, 0.0, 16.0),
                                                child: Text(
                                                  'Coloque os detalhes e quantidade de água no foguete.',
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .labelLarge
                                                      .override(
                                            ...
                                            Padding(
                                              ...
                                              child: Container(
                                                ...
                                                child: TextFormField(
                                                  ...
                                                  focusNode:
                                                      _model.vinagreFocusNode,
                                                  autofocus: true,
                                                  obscureText: false,
                                                  decoration: InputDecoration(
                                                    labelText: 'Vinagre (mL)',
                                  ...
                                  Padding(
                                    ...
                                    child: Container(
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.pressaoTextController,
                                        focusNode: _model.pressaoFocusNode,
                                        autofocus: true,
                                        obscureText: false,
                                        decoration: InputDecoration(
                                          labelText: 'Pressão atingida (PSI)',
                                          labelStyle: FlutterFlowTheme.of(
                                                  context)
                                              .titleMedium
                                              .override(
                                  ...
                                  Padding(
                                    ...
                                    child: Container(
                                      ...
                                      child: TextFormField(
                                        ...
                                        focusNode:
                                            _model.tempopressurizacaoFocusNode,
                                        autofocus: true,
                                        obscureText: false,
                                        decoration: InputDecoration(
                                          labelText:
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Container(
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.tempodevooTextController,
                                        focusNode: _model.tempodevooFocusNode,
                                        autofocus: true,
                                        obscureText: false,
                                        decoration: InputDecoration(
                                          labelText:
                                              ...
                                              child: FFButtonWidget(
                                                onPressed: () async {
                                                            ...
                                                            builder:
                                                              ...
                                                              return AlertDialog(
                                                                title: Text(
                                                                    'Versão Premium'),
                                                                content: Text(
                                                                    'Você ainda não tem essa função. Seja Premium para acessar essa e outras funções.'),
                                                                actions: [
                                                                  TextButton(
                                                                    onPressed: () =>
                                                                        Navigator.pop(
                                                  ...
                                                  if (confirmDialogResponse) {
                                                      ...
                                                      builder:
                                                        ...
                                                        return AlertDialog(
                                                          title: Text(
                                                              'Versão Premium'),
                                                          content: Text(
                                                              'Entre em contato com nosso time através do suporte para saber mais detalhes'),
                                                          actions: [
                                                            TextButton(
                                                              onPressed: () =>
                                                                  Navigator.pop(
                                                    ...
                                                    await launchURL(
                                                        'https://api.whatsapp.com/send/?phone=5519995257582&text&type=phone_number&app_absent=0');
                                                  }
                                                },
                                                text: 'Calcular',
                                                options: FFButtonOptions(
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                FFButtonWidget(
                                  onPressed: () async {
                                    await LancamentosRecord.createDoc(
                                            _model.fogueteSelecionadoPagina!)
                                        .set({
                                      ...createLancamentosRecordData(
                                        fogueteRef:
                                            _model.fogueteSelecionadoPagina,
                                        temperaturaAmbiente: double.tryParse(
                                            _model.temperaturaTextController
                                                .text),
                                        vento: _model.ventoDropDownValue,
                                        direcaoVento:
                                            _model.direcaoventoDropDownValue,
                                        vinagre: double.tryParse(
                                            _model.vinagreTextController.text),
                                        ...
                                        concentracaoVinagre: double.tryParse(
                                            _model
                                                .concentracaovinagreTextController
                                                .text),
                                        pressao: double.tryParse(
                                            _model.pressaoTextController.text),

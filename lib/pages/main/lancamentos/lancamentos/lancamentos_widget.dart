                ...
                child: StreamBuilder<List<LancamentosRecord>>(
                  stream: _model.listaDeLancamentos(
                    ...
                    requestFn: () => queryLancamentosRecord(
                      queryBuilder: (lancamentosRecord) =>
                          lancamentosRecord.where(
                        'userDono',
                  ...
                  builder: (context, snapshot) {
                    ...
                    return ListView.builder(
                      ...
                      itemCount: listViewLancamentosRecordList.length,
                                ...
                                context.pushNamed(
                                  ...
                                  queryParameters: {
                                    'launchSelected': serializeParam(
                                      listViewLancamentosRecord.reference,
                                                  ...
                                                  FlutterFlowIconButton(
                                                    ...
                                                    onPressed: () async {
                                                      ...
                                                      if (confirmDialogResponse) {
                                                        await listViewLancamentosRecord
                                                            .reference
                                                            .delete();
                                                      }
                                                    },

...
class ProjetoDetailsWidget extends StatefulWidget {
  const ProjetoDetailsWidget({
    super.key,
    required this.projectSelected,
  });

  final DocumentReference? projectSelected;

  @override
  State<ProjetoDetailsWidget> createState() => _ProjetoDetailsWidgetState();
}

class _ProjetoDetailsWidgetState extends State<ProjetoDetailsWidget> {
  late ProjetoDetailsModel _model;
            ...
            floatingActionButton: FloatingActionButton.extended(
              onPressed: () async {
                FFAppState().selectedGarrafa =
                    projetoDetailsFoguetesRecord.garrafaRef!.id;
                ...
                context.pushNamed(
                  ...
                  queryParameters: {
                    'garrafa': serializeParam(
                      projetoDetailsFoguetesRecord.garrafaRef,
                      ParamType.DocumentReference,
                    ),
                    'coifa': serializeParam(
                      projetoDetailsFoguetesRecord.coifaRef,
                      ParamType.DocumentReference,
                    ),
                    'aleta': serializeParam(
                      projetoDetailsFoguetesRecord.aletaRef,
                      ParamType.DocumentReference,
                    ),
                  }.withoutNulls,
                );
                            ...
                            await Navigator.push(
                              ...
                              PageTransition(
                                ...
                                child: FlutterFlowExpandedImageView(
                                  ...
                                  allowRotation: false,
                                  tag: projetoDetailsFoguetesRecord.imagem,
                          ...
                          children: [
                            ...
                            Text(
                              valueOrDefault<String>(
                                dateTimeFormat(
                                  'd/M/y',
                                  projetoDetailsFoguetesRecord.dataConstrucao,
                                  locale:
                              ...
                              child: Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Text(
                                      valueOrDefault<String>(
                                        projetoDetailsFoguetesRecord.coifaNome,
                                        'Vazio',
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .bodyLarge
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                valueOrDefault<String>(
                                  projetoDetailsFoguetesRecord.aletaMaterial,
                                  'Vazio',
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .titleLarge
                            ...
                            Row(
                              ...
                              children: [
                                Text(
                                  valueOrDefault<String>(
                                    formatNumber(
                                      projetoDetailsFoguetesRecord.massaFinal,
                                      formatType: FormatType.decimal,
                                      decimalType: DecimalType.commaDecimal,
                                    ),
                                    '0',
                            ...
                            Row(
                              ...
                              children: [
                                Text(
                                  valueOrDefault<String>(
                                    formatNumber(
                                      projetoDetailsFoguetesRecord.cg,
                                      formatType: FormatType.decimal,
                                      decimalType: DecimalType.commaDecimal,
                                    ),
                                    '0',
                            ...
                            Row(
                              ...
                              children: [
                                Text(
                                  valueOrDefault<String>(
                                    formatNumber(
                                      projetoDetailsFoguetesRecord.cp,
                                      formatType: FormatType.decimal,
                                      decimalType: DecimalType.commaDecimal,
                                    ),
                                    '0',
